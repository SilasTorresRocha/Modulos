...
scTelemetriaM3::scTelemetriaM3() : 
    _logger(nullptr), _rtc(nullptr), _saude(nullptr), _sd(nullptr), _meuMac(""), _uptimeEmissao(0) {
}

void scTelemetriaM3::inicializar(const char* meuMac, scLogger* logger, scRTCFisicoM3* rtc, scMonitorSaudeM3* saude, scGestorSDCardM3* sd) {
    _meuMac = meuMac;
    _logger = logger;
    _rtc = rtc;
    _saude = saude;

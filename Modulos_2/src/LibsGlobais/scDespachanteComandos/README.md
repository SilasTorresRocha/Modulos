...
- **`status_peer` (Notificação de Morte):** Quando o Hub transmite que um módulo na casa morreu ("inativo"), o despachante repassa esse aviso via `_callbackLocal` para que a Interface (MVC) esconda atalhos que dependiam desse módulo morto.
